...
-(void)updateCharacteristicWithHandler:(void (^) (BOOL success, NSError *error))handler
{
    ...
    if (bpCharacteristic)
    {
        ...
        [[[CBManager sharedManager] myPeripheral] setNotifyValue:YES forCharacteristic:bpCharacteristic];
    }
...
-(void)stopUpdate
{
    ...
    if (bpCharacteristic)
    {
        ...
        {
            [[[CBManager sharedManager] myPeripheral] setNotifyValue:NO forCharacteristic:bpCharacteristic];
