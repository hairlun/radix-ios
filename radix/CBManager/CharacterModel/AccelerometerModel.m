...
-(void) writeValueForAccelerometerSensorScanInterval:(int) newScanInterval
{
    ...
    [[[CBManager sharedManager] myPeripheral] writeValue:valData forCharacteristic:scanIntervalCharacteristic type:CBCharacteristicWriteWithoutResponse];
...
-(void) writeValueForAccelerometerFilterConfiguration:(int) filterconfiguration
{
    ...
    NSData  *valData = [NSData dataWithBytes:(void*)&val length:sizeof(val)];
    [[[CBManager sharedManager] myPeripheral] writeValue:valData forCharacteristic:dataAccumulationCharacteristic type:CBCharacteristicWriteWithoutResponse];
...
-(void) updateCharacteristicsNotificationStatus:(BOOL)status
{
    if ([XYZCharacteristicsArray count] > 0)
    {
        ...
        {
            [[[CBManager sharedManager] myPeripheral] setNotifyValue:status forCharacteristic:characteristic];
...
-(void) readAccelerometerCharacteristics
{
    ...
    {
        [[[CBManager sharedManager] myPeripheral] readValueForCharacteristic:scanIntervalCharacteristic];
    ...
    {
        [[[CBManager sharedManager] myPeripheral] readValueForCharacteristic:dataAccumulationCharacteristic];
