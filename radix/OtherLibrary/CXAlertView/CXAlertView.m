...
static CGFloat const kDefaultContentScrollViewMaxHeight = 100.;
...
@property (nonatomic, assign) NSInteger listSize;
@property (nonatomic, assign) NSInteger listDetailSize;
...
// Create
- (id)initWithTitle:(NSString *)title message:(NSString *)message cancelButtonTitle:(NSString *)cancelButtonTitle  completion:(void (^)(void))completion
{
    ...
    return  [self initWithTitle:title contentView:messageLabel cancelButtonTitle:cancelButtonTitle completion:completion];
}

- (id)initWithTitle:(NSString *)title contentView:(UIView *)contentView cancelButtonTitle:(NSString *)cancelButtonTitle completion:(void (^)(void))completion
{
    self = [super init];
    if (self) {
