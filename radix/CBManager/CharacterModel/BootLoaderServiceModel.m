...
-(void) updateValueForCharacteristicWithCompletionHandler:(void (^) (BOOL success,id command,NSError *error)) handler
{
    ...
    if (bootLoaderCharacteristic != nil)
    {
        ...
        [[[CBManager sharedManager] myPeripheral] setNotifyValue:YES forCharacteristic:bootLoaderCharacteristic];
    }
}
...
-(void) writeValueToCharacteristicWithData:(NSData *)data bootLoaderCommandCode:(unsigned short)commandCode
{
    if (data != nil && bootLoaderCharacteristic != nil)
    {
        ...
        [[[CBManager sharedManager] myPeripheral] writeValue:data forCharacteristic:bootLoaderCharacteristic type:CBCharacteristicWriteWithResponse];
    }
}
...
-(void) stopUpdate
{
    ...
    if (bootLoaderCharacteristic != nil)
    {
        ...
        [[[CBManager sharedManager] myPeripheral] setNotifyValue:NO forCharacteristic:bootLoaderCharacteristic];
    }
}
